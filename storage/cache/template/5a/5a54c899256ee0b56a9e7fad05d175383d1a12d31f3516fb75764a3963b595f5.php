...
class __TwigTemplate_3f1190952d74977ebf08c9812ee77f028b315f5c3a6785d9fbb3ea2c2dd03803 extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["aaa"]) {
            // line 13
            echo "    ";
            $this->loadTemplate((("app/view/default/account/bbb" . $context["aaa"]) . ".twig"), "app/view/default/account/a1.twig", 13)->display($context);
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
    ...
    {
        return array (  77 => 13,  60 => 12,  55 => 10,  50 => 8,  42 => 3,  37 => 1,);
    }
